...
public:
	...
	VERA_CONSTEXPR Mod(uint32_t mods) VERA_NOEXCEPT : m_mods(mods) {}

	VERA_NODISCARD VERA_CONSTEXPR bool has(uint32_t mods) const VERA_NOEXCEPT { return m_mods & mods; }

	VERA_NODISCARD VERA_CONSTEXPR bool ctrl() const VERA_NOEXCEPT  { return m_mods & Ctrl; }
	VERA_NODISCARD VERA_CONSTEXPR bool lctrl() const VERA_NOEXCEPT { return m_mods & RCtrl; }
	VERA_NODISCARD VERA_CONSTEXPR bool rctrl() const VERA_NOEXCEPT { return m_mods & RCtrl; }
	VERA_NODISCARD VERA_CONSTEXPR bool shft() const VERA_NOEXCEPT  { return m_mods & Shft; }
	VERA_NODISCARD VERA_CONSTEXPR bool lshft() const VERA_NOEXCEPT { return m_mods & LShft; }
	VERA_NODISCARD VERA_CONSTEXPR bool rshft() const VERA_NOEXCEPT { return m_mods & RShft; }
	VERA_NODISCARD VERA_CONSTEXPR bool alt() const VERA_NOEXCEPT   { return m_mods & Alt; }
	VERA_NODISCARD VERA_CONSTEXPR bool lalt() const VERA_NOEXCEPT  { return m_mods & LAlt; }
	VERA_NODISCARD VERA_CONSTEXPR bool ralt() const VERA_NOEXCEPT  { return m_mods & RAlt; }
...
class Keyboard {
public:
	VERA_NODISCARD static Key toKey(Scancode scancode);
	VERA_NODISCARD static Scancode toScancode(Key key);

	VERA_NODISCARD static bool isDown(Key key);
	VERA_NODISCARD static bool isUp(Key key);
	VERA_NODISCARD static bool isDown(Scancode scancode);
	VERA_NODISCARD static bool isUp(Scancode scancode);
	
	VERA_NODISCARD static bool ctrl();
	VERA_NODISCARD static bool lctrl();
	VERA_NODISCARD static bool rctrl();
	VERA_NODISCARD static bool shft();
	VERA_NODISCARD static bool lshft();
	VERA_NODISCARD static bool rshft();
	VERA_NODISCARD static bool alt();
	VERA_NODISCARD static bool lalt();
	VERA_NODISCARD static bool ralt();
	VERA_NODISCARD static bool system();
	VERA_NODISCARD static bool lsystem();
	VERA_NODISCARD static bool rsystem();
};
