...
public:
	...
	using this_type   = matrix_base<2, 3, T, Q>;
	...
	VERA_NODISCARD VERA_CONSTEXPR vec3_type operator*(const vec2_type& rhs) const VERA_NOEXCEPT
	{
		return {
