...
public:
	...
	using this_type   = matrix_base<3, 2, T, Q>;
	...
	VERA_NODISCARD VERA_CONSTEXPR vec2_type operator*(const vec3_type& rhs) const VERA_NOEXCEPT
	{
		return {
