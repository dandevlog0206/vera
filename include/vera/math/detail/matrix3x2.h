...
class matrix_base<3, 2, row_major, T, Q>
{
public:
	...
	using this_type   = matrix_base<3, 2, row_major, T, Q>;

	static VERA_CONSTEXPR mat3x2_type identity() VERA_NOEXCEPT
	{
		return { static_cast<T>(1) };
	}

	static VERA_CONSTEXPR mat3x2_type zero() VERA_NOEXCEPT
	{
	...
	VERA_NODISCARD VERA_CONSTEXPR mat2x3_type transpose() const VERA_NOEXCEPT
	{
		return {
	...
	VERA_NODISCARD VERA_CONSTEXPR mat3x2_type operator*(const mat2x2_type& rhs) const VERA_NOEXCEPT
	{
		return {
			rows[0][0] * rhs[0] + rows[0][1] * rhs[1],
			rows[1][0] * rhs[0] + rows[1][1] * rhs[1],
			rows[2][0] * rhs[0] + rows[2][1] * rhs[1]
		};
	}

	VERA_NODISCARD VERA_CONSTEXPR mat3x3_type operator*(const mat2x3_type& rhs) const VERA_NOEXCEPT
	{
		return {
			rows[0][0] * rhs[0] + rows[0][1] * rhs[1],
			rows[1][0] * rhs[0] + rows[1][1] * rhs[1],
	...
	VERA_NODISCARD VERA_CONSTEXPR mat3x4_type operator*(const mat2x4_type& rhs) const VERA_NOEXCEPT
	{
		return {
			rows[0][0] * rhs[0] + rows[0][1] * rhs[1],
			rows[1][0] * rhs[0] + rows[1][1] * rhs[1],
	...
	VERA_NODISCARD VERA_CONSTEXPR row_type operator*(const col_type& rhs) const VERA_NOEXCEPT
	{
		return {
...
template <class T, MathQualifier Q>
class matrix_base<3, 2, col_major, T, Q>
{
public:
	...
	using this_type   = matrix_base<3, 2, col_major, T, Q>;
	...
	VERA_NODISCARD VERA_CONSTEXPR mat2x2_type operator*(const mat2x3_type& rhs) const VERA_NOEXCEPT
	{
		return {
	...
	VERA_NODISCARD VERA_CONSTEXPR mat3x2_type operator*(const mat3x3_type& rhs) const VERA_NOEXCEPT
	{
		return {
			cols[0] * rhs[0][0] + cols[1] * rhs[0][1] + cols[2] * rhs[0][2],
			cols[0] * rhs[1][0] + cols[1] * rhs[1][1] + cols[2] * rhs[1][2],
	...
	VERA_NODISCARD VERA_CONSTEXPR mat4x2_type operator*(const mat4x3_type& rhs) const VERA_NOEXCEPT
	{
		return {
			cols[0] * rhs[0][0] + cols[1] * rhs[0][1] + cols[2] * rhs[0][2],
			cols[0] * rhs[1][0] + cols[1] * rhs[1][1] + cols[2] * rhs[1][2],
	...
	friend VERA_NODISCARD VERA_CONSTEXPR row_type operator*(const col_type& lhs, const matrix_base& rhs) VERA_NOEXCEPT
	{
		return {
			...
			lhs[0] * rhs.cols[2][0] + lhs[1] * rhs.cols[2][1]
		};
	}
