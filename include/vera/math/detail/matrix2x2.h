...
public:
	...
	using this_type   = matrix_base<2, 2, T, Q>;
	...
	VERA_NODISCARD VERA_CONSTEXPR matrix_base inv() const VERA_NOEXCEPT
	{
		const T d = det();
	...
	VERA_NODISCARD VERA_CONSTEXPR vec2_type operator*(const vec2_type& rhs) const VERA_NOEXCEPT
	{
		return {
